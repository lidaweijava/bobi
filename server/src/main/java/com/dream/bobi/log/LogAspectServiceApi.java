...
public class LogAspectServiceApi {
    private final static Logger log = LoggerFactory.getLogger(LogAspectServiceApi.class);

    private JSONObject jsonObject = new JSONObject();

    // 申明一个切点 里面是 execution表达式
    @Pointcut("execution(* com.dream.bobi.api.service..*(..))")
