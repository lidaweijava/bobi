...
public class EncryptionUtil {
    ...
    public static void main(String[] args) {
        try {
            ...
            String text = "24";
            String word = "entropy123QWE.";
            String encryptedAES1 = EncryptionUtil.encryptWithAES(text, word);
            System.out.println("AES Encrypted: " + encryptedAES1);
            // AES 解密
            String decryptedAES1 = EncryptionUtil.decryptWithAES(encryptedAES1, word);
            System.out.println("AES Decrypted: " + decryptedAES1);
